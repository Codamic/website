...
var vec__23178_23181 = clojure.data.diff(orig_db,new_db);
var only_before_23182 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23178_23181,(0),null);
var only_after_23183 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23178_23181,(1),null);
var db_changed_QMARK__23184 = (!((only_before_23182 == null))) || (!((only_after_23183 == null)));
if(db_changed_QMARK__23184){
...
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$log,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["only before:",only_before_23182], 0));

re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$log,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["only after :",only_after_23183], 0));
...
var map__23185 = cljs.core.cst$kw$coeffects.cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23185__$1,cljs.core.cst$kw$db);
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23185__$1,cljs.core.cst$kw$event);
...
var map__23187 = cljs.core.cst$kw$coeffects.cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__23187__$1;
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23187__$1,cljs.core.cst$kw$event);
...
var len__12310__auto___23190 = arguments.length;
var i__12311__auto___23191 = (0);
while(true){
if((i__12311__auto___23191 < len__12310__auto___23190)){
args__12317__auto__.push((arguments[i__12311__auto___23191]));

var G__23192 = (i__12311__auto___23191 + (1));
i__12311__auto___23191 = G__23192;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__12318__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq23189){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq23189));
});
...
var event = re_frame.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$2(context,cljs.core.cst$kw$event);
var db = (function (){var or__11141__auto__ = re_frame.interceptor.get_effect.cljs$core$IFn$_invoke$arity$2(context,cljs.core.cst$kw$db);
...
var args__12317__auto__ = [];
var len__12310__auto___23198 = arguments.length;
var i__12311__auto___23199 = (0);
while(true){
if((i__12311__auto___23199 < len__12310__auto___23198)){
args__12317__auto__.push((arguments[i__12311__auto___23199]));

var G__23200 = (i__12311__auto___23199 + (1));
i__12311__auto___23199 = G__23200;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__12318__auto__);
});
...
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(new_db,p1__23193_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (new_db,old_db,new_ins){
return (function (p1__23194_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(old_db,p1__23194_SHARP_);
});})(new_db,old_db,new_ins))
,in_paths);
var changed_ins_QMARK_ = (function (){var and__11129__auto__ = cljs.core.contains_QMARK_(re_frame.interceptor.get_effect.cljs$core$IFn$_invoke$arity$1(context),cljs.core.cst$kw$db);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq23195){
var G__23196 = cljs.core.first(seq23195);
var seq23195__$1 = cljs.core.next(seq23195);
var G__23197 = cljs.core.first(seq23195__$1);
var seq23195__$2 = cljs.core.next(seq23195__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__23196,G__23197,seq23195__$2);
});
