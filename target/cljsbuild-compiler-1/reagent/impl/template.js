...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__11766__auto__,writer__11767__auto__,opt__11768__auto__){
return cljs.core._write(writer__11767__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__17050 = o;
(G__17050[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
if(cljs.core.truth_((function (){var and__11129__auto__ = !((jsprops == null));
if(and__11129__auto__){
var and__11129__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__17056 = jsprops;
(G__17056["defaultValue"] = value);

(G__17056["onChange"] = ((function (G__17056,v,value,on_change){
return (function (p1__17055_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__17055_SHARP_);
});})(G__17056,v,value,on_change))
);
...
var vec__17059 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17059,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17059,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17059,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___17063 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___17063 == null)){
} else {
var key_17064 = temp__4661__auto___17063;
(jsprops["key"] = key_17064);
}
...
var G__17065 = reagent.impl.template.__GT_NativeWrapper();
(G__17065["name"] = c);
...
var G__17066 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__17066) : reagent.impl.template.as_element.call(null,G__17066));
} else {
...
var len__12310__auto___17071 = arguments.length;
var i__12311__auto___17072 = (0);
while(true){
if((i__12311__auto___17072 < len__12310__auto___17071)){
args__12317__auto__.push((arguments[i__12311__auto___17072]));

var G__17073 = (i__12311__auto___17072 + (1));
i__12311__auto___17072 = G__17073;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__12318__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq17069){
var G__17070 = cljs.core.first(seq17069);
var seq17069__$1 = cljs.core.next(seq17069);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__17070,seq17069__$1);
});
...
break;
default:
var G__17076 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__17076;
continue;
...
var n__12086__auto___17078 = a.length;
var i_17079 = (0);
while(true){
if((i_17079 < n__12086__auto___17078)){
(a[i_17079] = reagent.impl.template.as_element((a[i_17079])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__12086__auto___17081 = a.length;
var i_17082 = (0);
while(true){
if((i_17082 < n__12086__auto___17081)){
var val_17083 = (a[i_17082]);
if((cljs.core.vector_QMARK_(val_17083)) && ((reagent.impl.template.key_from_vec(val_17083) == null))){
(o["no-key"] = true);
} else {
}

(a[i_17082] = reagent.impl.template.as_element(val_17083));

var G__17084 = (i_17082 + (1));
i_17082 = G__17084;
continue;
} else {
}
...
var ctx = ({});
var vec__17085 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17085,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17085,(1),null);
...
var G__17088 = (cljs.core.count(argv) - first_child);
switch (G__17088) {
case (0):
...
case (1):
var G__17089 = comp;
var G__17090 = jsprops;
var G__17091 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__17089,G__17090,G__17091) : reagent.impl.template.global$module$react.createElement.call(null,G__17089,G__17090,G__17091));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__17088){
