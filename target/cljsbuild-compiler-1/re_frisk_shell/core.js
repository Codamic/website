...
re_frisk_shell.core.ie_QMARK_ = (function (){var or__11141__auto__ = cljs.core.re_find(/MSIE /,re_frisk_shell.core.ua);
if(cljs.core.truth_(or__11141__auto__)){
return or__11141__auto__;
} else {
var or__11141__auto____$1 = cljs.core.re_find(/Trident\//,re_frisk_shell.core.ua);
...
return cljs.core.reset_BANG_(re_frisk_shell.core.draggable,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$x,x,cljs.core.cst$kw$y,y], null));
});
});
...
var map__23026 = re_frisk_shell.core.get_client_rect(e);
...
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23026__$1,cljs.core.cst$kw$left);
var top = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23026__$1,cljs.core.cst$kw$top);
...
var G__23028 = window;
var G__23029 = goog.events.EventType.MOUSEUP;
var G__23030 = re_frisk_shell.core.mouse_up_handler(on_move);
return goog.events.listen(G__23028,G__23029,G__23030);
});
...
var len__12310__auto___23034 = arguments.length;
var i__12311__auto___23035 = (0);
while(true){
if((i__12311__auto___23035 < len__12310__auto___23034)){
args__12317__auto__.push((arguments[i__12311__auto___23035]));

var G__23036 = (i__12311__auto___23035 + (1));
i__12311__auto___23035 = G__23036;
continue;
} else {
}
break;
...
return re_frisk_shell.core.re_frisk_panel.cljs$core$IFn$_invoke$arity$variadic(argseq__12318__auto__);
});

re_frisk_shell.core.re_frisk_panel.cljs$core$IFn$_invoke$arity$variadic = (function (data){
var expand_by_default = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__23031_SHARP_,p2__23032_SHARP_){
return cljs.core.assoc_in(p1__23031_SHARP_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$data_DASH_frisk,p2__23032_SHARP_,cljs.core.cst$kw$expanded_DASH_paths], null),cljs.core.PersistentHashSet.createAsIfByAssoc([cljs.core.PersistentVector.EMPTY]));
...
return (function() { 
var G__23037__delegate = function (data__$1){
...
while (G__23038__i < G__23038__a.length) {G__23038__a[G__23038__i] = arguments[G__23038__i + 0]; ++G__23038__i;}
  data__$1 = new cljs.core.IndexedSeq(G__23038__a,0,null);
} 
return G__23037__delegate.call(this,data__$1);};
G__23037.cljs$lang$maxFixedArity = 0;
G__23037.cljs$lang$applyTo = (function (arglist__23039){
var data__$1 = cljs.core.seq(arglist__23039);
return G__23037__delegate(data__$1);
});
...
re_frisk_shell.core.re_frisk_panel.cljs$lang$applyTo = (function (seq23033){
return re_frisk_shell.core.re_frisk_panel.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq23033));
});

re_frisk_shell.core.re_frisk_shell = (function re_frisk_shell$core$re_frisk_shell(data,deb_data,p__23040){
var map__23041 = p__23040;
var map__23041__$1 = ((((!((map__23041 == null)))?((((map__23041.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23041.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__23041):map__23041);
var on_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23041__$1,cljs.core.cst$kw$on_DASH_click);
var x = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23041__$1,cljs.core.cst$kw$x);
var y = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23041__$1,cljs.core.cst$kw$y);
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23041__$1,cljs.core.cst$kw$width);
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23041__$1,cljs.core.cst$kw$height);
var style = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([re_frisk_shell.core.frisk_style,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$resize,"both",cljs.core.cst$kw$width,"300px",cljs.core.cst$kw$height,"200px"], null)], 0));
var height__$1 = (cljs.core.truth_((function (){var and__11129__auto__ = re_frisk_shell.core.ie_QMARK_;
...
return ((function (style,height__$1,style__$1,style__$2,map__23041,map__23041__$1,on_click,x,y,width,height){
return (function (data__$1,deb_data__$1){
if(cljs.core.truth_(cljs.core.cst$kw$deb_DASH_win_DASH_closed_QMARK_.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(deb_data__$1)))){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$style,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$position,"fixed",cljs.core.cst$kw$left,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.cst$kw$x.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(re_frisk_shell.core.draggable))),"px"].join(''),cljs.core.cst$kw$top,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.cst$kw$y.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(re_frisk_shell.core.draggable))),"px"].join(''),cljs.core.cst$kw$z_DASH_index,(999)], null),(cljs.core.truth_((function (){var or__11141__auto__ = re_frisk_shell.core.ie_QMARK_;
if(cljs.core.truth_(or__11141__auto__)){
return or__11141__auto__;
} else {
return cljs.core.not(cljs.core.cst$kw$x.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(re_frisk_shell.core.draggable)));
}
})())?new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$bottom,"0px",cljs.core.cst$kw$right,"20px"], null):null)], 0))], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$style,re_frisk_shell.core.re_frisk_button_style,cljs.core.cst$kw$on_DASH_mouse_DASH_down,re_frisk_shell.core.mouse_down_handler], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk_shell.core.visibility_button,cljs.core.cst$kw$visible_QMARK_.cljs$core$IFn$_invoke$arity$1(cljs.core.cst$kw$data_DASH_frisk.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(deb_data__$1))),((function (style,height__$1,style__$1,style__$2,map__23041,map__23041__$1,on_click,x,y,width,height){
return (function (_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(deb_data__$1,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$data_DASH_frisk,cljs.core.cst$kw$visible_QMARK_], null),cljs.core.not(cljs.core.cst$kw$visible_QMARK_.cljs$core$IFn$_invoke$arity$1(cljs.core.cst$kw$data_DASH_frisk.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(deb_data__$1)))));
});})(style,height__$1,style__$1,style__$2,map__23041,map__23041__$1,on_click,x,y,width,height))
], null),"re-frisk"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$style,re_frisk_shell.core.arrow_style,cljs.core.cst$kw$on_DASH_click,on_click], null),"\u2197"], null),(cljs.core.truth_(cljs.core.cst$kw$visible_QMARK_.cljs$core$IFn$_invoke$arity$1(cljs.core.cst$kw$data_DASH_frisk.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(deb_data__$1))))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$style,style__$2], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk_shell.core.re_frisk_panel,cljs.core.deref(data__$1)], null)], null):null)], null);
} else {
return null;
}
});
...
,cljs.core.deref(re_frame_events))], null);
})], null));
});
...
return cljs.core.first((function (){var or__11141__auto__ = cljs.core.cst$kw$event.cljs$core$IFn$_invoke$arity$1(cljs.core.cst$kw$event_DASH_data.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(deb_data)));
if(cljs.core.truth_(or__11141__auto__)){
return or__11141__auto__;
} else {
return cljs.core.cst$kw$event_DASH_data.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(deb_data));
}
})());
}));
...
var G__23046 = cljs.core.cst$kw$evnt_DASH_colors.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(deb_data));
var fexpr__23045 = cljs.core.deref(evnt_key);
return (fexpr__23045.cljs$core$IFn$_invoke$arity$1 ? fexpr__23045.cljs$core$IFn$_invoke$arity$1(G__23046) : fexpr__23045.call(null,G__23046));
} else {
return "";
}
});})(evnt_key))
...
var args__12317__auto__ = [];
var len__12310__auto___23063 = arguments.length;
var i__12311__auto___23064 = (0);
while(true){
if((i__12311__auto___23064 < len__12310__auto___23063)){
args__12317__auto__.push((arguments[i__12311__auto___23064]));

var G__23065 = (i__12311__auto___23064 + (1));
i__12311__auto___23064 = G__23065;
continue;
} else {
}
break;
...
return re_frisk_shell.core.debugger_shell.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),(arguments[(2)]),argseq__12318__auto__);
});

re_frisk_shell.core.debugger_shell.cljs$core$IFn$_invoke$arity$variadic = (function (re_frame_data,re_frame_events,deb_data,p__23057){
var vec__23058 = p__23057;
var imp_hndl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23058,(0),null);
var exp_hndl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23058,(1),null);
var expand_by_default = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (vec__23058,imp_hndl,exp_hndl){
return (function (p1__23047_SHARP_,p2__23048_SHARP_){
return cljs.core.assoc_in(p1__23047_SHARP_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$data_DASH_frisk,p2__23048_SHARP_,cljs.core.cst$kw$expanded_DASH_paths], null),cljs.core.PersistentHashSet.createAsIfByAssoc([cljs.core.PersistentVector.EMPTY]));
});})(vec__23058,imp_hndl,exp_hndl))
,cljs.core.PersistentArrayMap.EMPTY,cljs.core.range.cljs$core$IFn$_invoke$arity$1((1)));
var expand_by_default2 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (expand_by_default,vec__23058,imp_hndl,exp_hndl){
return (function (p1__23049_SHARP_,p2__23050_SHARP_){
return cljs.core.assoc_in(p1__23049_SHARP_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$data_DASH_frisk,p2__23050_SHARP_,cljs.core.cst$kw$expanded_DASH_paths], null),cljs.core.PersistentHashSet.createAsIfByAssoc([cljs.core.PersistentVector.EMPTY]));
});})(expand_by_default,vec__23058,imp_hndl,exp_hndl))
,cljs.core.PersistentArrayMap.EMPTY,cljs.core.range.cljs$core$IFn$_invoke$arity$1((1)));
var state_atom = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(expand_by_default);
...
var filtered_events = reagent.ratom.make_reaction(((function (expand_by_default,expand_by_default2,state_atom,state_atom2,input_text,vec__23058,imp_hndl,exp_hndl){
return (function (){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(input_text),"")){
return cljs.core.deref(re_frame_events);
} else {
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2(re_frisk_shell.core.filter_event(cljs.core.deref(input_text)),cljs.core.deref(re_frame_events));
}
});})(expand_by_default,expand_by_default2,state_atom,state_atom2,input_text,vec__23058,imp_hndl,exp_hndl))
);
...
var _ = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$variadic(re_frame_data,cljs.core.assoc,cljs.core.cst$kw$filter,reagent.ratom.make_reaction(((function (expand_by_default,expand_by_default2,state_atom,state_atom2,input_text,filtered_events,cljs_text,input_cljs_text,vec__23058,imp_hndl,exp_hndl){
return (function (){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(cljs_text),"")){
return "empty";
} else {
var G__23062 = cljs.core.deref(cljs.core.cst$kw$app_DASH_db.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(re_frame_data)));
var fexpr__23061 = cljs.core.cst$kw$value.cljs$core$IFn$_invoke$arity$1(re_frisk_shell.core.eval_str(cljs.core.deref(cljs_text)));
return (fexpr__23061.cljs$core$IFn$_invoke$arity$1 ? fexpr__23061.cljs$core$IFn$_invoke$arity$1(G__23062) : fexpr__23061.call(null,G__23062));
}
});})(expand_by_default,expand_by_default2,state_atom,state_atom2,input_text,filtered_events,cljs_text,input_cljs_text,vec__23058,imp_hndl,exp_hndl))
),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$app_DASH_db_DASH_sorted,reagent.ratom.make_reaction(((function (expand_by_default,expand_by_default2,state_atom,state_atom2,input_text,filtered_events,cljs_text,input_cljs_text,vec__23058,imp_hndl,exp_hndl){
return (function (){
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.sorted_map(),db);
} else {
return db;
}
});})(expand_by_default,expand_by_default2,state_atom,state_atom2,input_text,filtered_events,cljs_text,input_cljs_text,vec__23058,imp_hndl,exp_hndl))
)], 0));
return ((function (expand_by_default,expand_by_default2,state_atom,state_atom2,input_text,filtered_events,cljs_text,input_cljs_text,_,vec__23058,imp_hndl,exp_hndl){
return (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div_SHARP_debugger,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$debugger_DASH_sidebar,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$input,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$placeholder,"events filter",cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$width,"100%"], null),cljs.core.cst$kw$on_DASH_change,((function (expand_by_default,expand_by_default2,state_atom,state_atom2,input_text,filtered_events,cljs_text,input_cljs_text,_,vec__23058,imp_hndl,exp_hndl){
return (function (p1__23051_SHARP_){
return cljs.core.reset_BANG_(input_text,p1__23051_SHARP_.target.value);
});})(expand_by_default,expand_by_default2,state_atom,state_atom2,input_text,filtered_events,cljs_text,input_cljs_text,_,vec__23058,imp_hndl,exp_hndl))
], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk_shell.core.debugger_messages,filtered_events,deb_data], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$debugger_DASH_sidebar_DASH_controls,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$debugger_DASH_sidebar_DASH_controls_DASH_import_DASH_export,(cljs.core.truth_(imp_hndl)?new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$span,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$span,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$cursor,cljs.core.cst$kw$pointer], null),cljs.core.cst$kw$on_DASH_click,imp_hndl], null),"Import"], null)," / ",new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$span,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$cursor,cljs.core.cst$kw$pointer], null),cljs.core.cst$kw$on_DASH_click,exp_hndl], null),"Export"], null)," / "], null):null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$span,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$cursor,cljs.core.cst$kw$pointer], null),cljs.core.cst$kw$on_DASH_click,((function (expand_by_default,expand_by_default2,state_atom,state_atom2,input_text,filtered_events,cljs_text,input_cljs_text,_,vec__23058,imp_hndl,exp_hndl){
return (function (){
return cljs.core.reset_BANG_(re_frame_events,cljs.core.PersistentVector.EMPTY);
});})(expand_by_default,expand_by_default2,state_atom,state_atom2,input_text,filtered_events,cljs_text,input_cljs_text,_,vec__23058,imp_hndl,exp_hndl))
], null),"Clear"], null)], null)], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div_SHARP_values,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$display,cljs.core.cst$kw$flex,cljs.core.cst$kw$background_DASH_color,"#fafafa"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$textarea,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$width,"400px",cljs.core.cst$kw$height,"40px"], null),cljs.core.cst$kw$placeholder,":value or (fn [app-db] {:value (:value app-db)}) or #(hash-map :value (:value %))",cljs.core.cst$kw$on_DASH_change,((function (expand_by_default,expand_by_default2,state_atom,state_atom2,input_text,filtered_events,cljs_text,input_cljs_text,_,vec__23058,imp_hndl,exp_hndl){
return (function (p1__23052_SHARP_){
return cljs.core.reset_BANG_(input_cljs_text,p1__23052_SHARP_.target.value);
});})(expand_by_default,expand_by_default2,state_atom,state_atom2,input_text,filtered_events,cljs_text,input_cljs_text,_,vec__23058,imp_hndl,exp_hndl))
], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 6, [cljs.core.cst$kw$cursor,cljs.core.cst$kw$pointer,cljs.core.cst$kw$padding_DASH_left,"5px",cljs.core.cst$kw$padding_DASH_right,"5px",cljs.core.cst$kw$margin_DASH_left,"5px",cljs.core.cst$kw$background_DASH_color,"#3d3d3d",cljs.core.cst$kw$color,cljs.core.cst$kw$white], null),cljs.core.cst$kw$on_DASH_click,((function (expand_by_default,expand_by_default2,state_atom,state_atom2,input_text,filtered_events,cljs_text,input_cljs_text,_,vec__23058,imp_hndl,exp_hndl){
return (function (){
return cljs.core.reset_BANG_(cljs_text,cljs.core.deref(input_cljs_text));
});})(expand_by_default,expand_by_default2,state_atom,state_atom2,input_text,filtered_events,cljs_text,input_cljs_text,_,vec__23058,imp_hndl,exp_hndl))
], null),"run"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$style,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([re_frisk_shell.core.frisk_style,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$height,(cljs.core.truth_(cljs.core.cst$kw$event_DASH_data.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(deb_data)))?"calc(100% - 296px)":"calc(100% - 46px)")], null)], 0))], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(((function (expand_by_default,expand_by_default2,state_atom,state_atom2,input_text,filtered_events,cljs_text,input_cljs_text,_,vec__23058,imp_hndl,exp_hndl){
return (function (id,x){
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk_shell.frisk.Root,x,id,state_atom], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,id], null));
});})(expand_by_default,expand_by_default2,state_atom,state_atom2,input_text,filtered_events,cljs_text,input_cljs_text,_,vec__23058,imp_hndl,exp_hndl))
,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.deref(re_frame_data)], null))], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$style,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([re_frisk_shell.core.frisk_style,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$height,"250",cljs.core.cst$kw$overflow,"hidden",cljs.core.cst$kw$display,(cljs.core.truth_(cljs.core.cst$kw$event_DASH_data.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(deb_data)))?"block":"none")], null)], 0))], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk_shell.core.event_bar,deb_data], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$overflow,"auto",cljs.core.cst$kw$height,"100%"], null)], null),cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(((function (expand_by_default,expand_by_default2,state_atom,state_atom2,input_text,filtered_events,cljs_text,input_cljs_text,_,vec__23058,imp_hndl,exp_hndl){
return (function (id,x){
...
,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$event_DASH_data.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(deb_data))], null)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$height,"20px"], null)], null)], null)], null)], null)], null)], null);
});
;})(expand_by_default,expand_by_default2,state_atom,state_atom2,input_text,filtered_events,cljs_text,input_cljs_text,_,vec__23058,imp_hndl,exp_hndl))
});
...
re_frisk_shell.core.debugger_shell.cljs$lang$applyTo = (function (seq23053){
...
return re_frisk_shell.core.debugger_shell.cljs$core$IFn$_invoke$arity$variadic(G__23054,G__23055,G__23056,seq23053__$3);
});

re_frisk_shell.core.reagent_debugger_shell = (function re_frisk_shell$core$reagent_debugger_shell(re_frame_data){
var expand_by_default = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__23066_SHARP_,p2__23067_SHARP_){
return cljs.core.assoc_in(p1__23066_SHARP_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$data_DASH_frisk,p2__23067_SHARP_,cljs.core.cst$kw$expanded_DASH_paths], null),cljs.core.PersistentHashSet.createAsIfByAssoc([cljs.core.PersistentVector.EMPTY]));
}),cljs.core.PersistentArrayMap.EMPTY,cljs.core.range.cljs$core$IFn$_invoke$arity$1((1)));
var state_atom = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(expand_by_default);
return ((function (expand_by_default,state_atom){
return (function (){
