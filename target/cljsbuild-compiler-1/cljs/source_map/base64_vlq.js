...
var digit_19282 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_19283__$1 = (vlq >>> (5));
while(true){
if((vlq_19283__$1 > (0))){
var digit_19284__$1 = (digit_19282 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_19284__$1));

var G__19285 = (vlq_19283__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__19286 = (vlq_19283__$1 >>> (5));
digit_19282 = G__19285;
vlq_19283__$1 = G__19286;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_19282));
}
break;
}
...
var G__19287 = i__$1;
var G__19288 = result__$1;
var G__19289 = shift__$1;
i = G__19287;
result = G__19288;
shift = G__19289;
continue;
